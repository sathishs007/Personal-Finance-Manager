 ...
 */ 
  var init=function(){
	  ...
	  ajaxFactory.postAjaxCall("http://localhost:8080/viewDeliveryDetails",loginObj).then(function(data) {
  				if(data!=null){
		  ...
		  ajaxFactory.getAjaxCall("http://localhost:8080/viewDeliveryDetails").then(function(data) {
				if(data!=null){
					 $scope.dataLoader=false;
					 $scope.packgeList=data; 
					 var t=localStorage.getItem('addroute');
